...
function buildList (lists){
	...
	var newListPane = '<ul id="myLists" class="nav nav-pills nav-stacked">';
	for (i=0; i<lists.length; i++){
		newListPane += '<li id="list_'+ lists[i].id +'"><a href="#" onclick="selectList(' + lists[i].id + ');"><span class="badge pull-right">'+lists[i].items.length+'</span>'+lists[i].list_name+'</a></li>';
	}
	newListPane +="</ul>"
	return newListPane;
}
...
function selectList(id){
	...
	$.ajax({
		...
		success: function(data) {
			...
			var newItemsPane = '<ul id="myItems" class="nav nav-pills nav-stacked">';
...
function buildItemDetail(id){
	$.ajax({
		...
		success: function(data) {
			...
			itemHtml += '<dt>Acquired</dt><dd>'+item.received +'</dd>\n';
			itemHtml += '</dl>';
